    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('APPLICANT', 'Applicant'), ('RECRUITER', 'Recruiter')], default='APPLICANT', max_length=50, verbose_name='Type')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('maritalStat', models.CharField(blank=True, max_length=100, null=True)),
                ...
                ('icPass', models.CharField(blank=True, max_length=20, null=True)),
                ('highQual', models.CharField(blank=True, max_length=40, null=True)),
